...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "INDICATOR_INTRADAY_REFRESH_SECONDS": {
        "title": "Indicator Live Refresh Seconds",
        "description": "Polling interval for Web indicator intraday charts and watchlist live quotes.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
