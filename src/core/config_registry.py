...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "CODEX_EXEC_ARGS": {
        ...
        "description": "Additional arguments passed after `codex exec`. Default uses the approval/sandbox bypass flag so unattended jobs can run under an externally sandboxed environment.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_TIMEOUT_SECONDS": {
        ...
        "description": "Maximum seconds to wait for one `codex exec` request.",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
