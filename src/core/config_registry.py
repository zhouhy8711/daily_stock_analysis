...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "CODEX_EXEC_ENABLED": {
        ...
        "description": "Use locally authenticated `codex exec` as an optional tokenless LLM runtime. Set CODEX_EXEC_MODEL or LITELLM_MODEL=codex/<model> when enabled.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_MODEL": {
        ...
        "description": "Model passed to `codex exec -m`. When CODEX_EXEC_ENABLED=true and LITELLM_MODEL is empty, the app uses codex/<this value> as the primary model.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_COMMAND": {
        ...
        "description": "Executable used for Codex CLI calls. Defaults to `codex`; set this only when the binary is not on PATH.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_ARGS": {
        "title": "Codex CLI Arguments",
        "description": "Arguments passed after `codex exec` for isolated completion mode. Defaults isolate user config, project rules, plugins, and tools so scheduled analysis behaves like one bounded model call.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_AGENT_ARGS": {
        "title": "Codex CLI Agent Arguments",
        "description": "Arguments passed after `codex exec` when a custom Codex skill is selected in Agent Q&A. Defaults to approval/sandbox bypass only, preserving local Codex skills and tools.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "--dangerously-bypass-approvals-and-sandbox",
        "options": [],
        "validation": {},
        "display_order": 10,
    },
    "CODEX_EXEC_TIMEOUT_SECONDS": {
        "title": "Codex CLI Timeout",
        "description": "Maximum seconds to wait for one isolated `codex exec` completion request.",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_AGENT_TIMEOUT_SECONDS": {
        "title": "Codex CLI Agent Timeout",
        "description": "Maximum seconds to wait for Agent Q&A requests that run through Codex CLI, including selected custom Codex skills.",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "CODEX_EXEC_AGENT_BACKGROUND_TIMEOUT_SECONDS": {
        "title": "Codex CLI Background Agent Timeout",
        "description": "Maximum seconds to let a background custom Codex skill run before writing a failed output file.",
        "category": "ai_model",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "IFIND_USERNAME": {
        "title": "iFinD Username",
        "description": "Username for the licensed Tonghuashun iFinD Python client.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "IFIND_PASSWORD": {
        "title": "iFinD Password",
        "description": "Password for the licensed Tonghuashun iFinD Python client.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "IFIND_CHIP_SUMMARY_INDICATORS": {
        "title": "iFinD Chip Summary Indicators",
        "description": "Comma-separated iFinD indicator codes for chip summary metrics, ordered as profit_ratio, avg_cost, 90 low/high, 90 concentration, 70 low/high, 70 concentration when aliases are unavailable.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "IFIND_CHIP_SUMMARY_FUNCTION": {
        "title": "iFinD Chip Summary Function",
        "description": "iFinD Python function used for chip summary calls. Keep THS_BD unless the confirmed indicators require another iFinD function.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "THS_BD",
        "options": [],
        "validation": {},
        "display_order": 14,
    },
    "IFIND_CHIP_DISTRIBUTION_INDICATORS": {
        "title": "iFinD Chip Distribution Indicators",
        "description": "Comma-separated iFinD indicator codes returning per-price chip distribution; the result must include price and percent columns or two numeric columns in that order.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "IFIND_CHIP_DISTRIBUTION_FUNCTION": {
        "title": "iFinD Chip Distribution Function",
        "description": "iFinD Python function used for per-price chip distribution calls. Keep THS_BD unless the confirmed indicators require another iFinD function.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "IFIND_CHIP_PARAMS": {
        "title": "iFinD Chip Params",
        "description": "Optional iFinD parameter string passed to chip summary and distribution calls, for example a trade-date or adjustment option confirmed in the iFinD data browser.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "PUBLIC_FINANCE_NEWS_ENABLED": {
        "title": "Public Finance News",
        "description": "Enable keyless public finance news and announcement sources via AkShare/public finance endpoints when no search API key is configured. Default: true.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "QFQ_CORPORATE_ACTION_REFRESH_ENABLED": {
        "title": "QFQ Corporate Action Refresh",
        "description": "Run a daily post-close A-share qfq refresh check for stocks affected by corporate actions.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "QFQ_CORPORATE_ACTION_REFRESH_LOOKBACK_DAYS": {
        ...
        "description": "Calendar-day window for corporate-action event discovery in the daily qfq refresh check.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "QFQ_CORPORATE_ACTION_REFRESH_INTERVAL_SECONDS": {
        ...
        "description": "Background polling interval in seconds; the service still runs at most once per China trading day after the configured time.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RULE_PROGRESS_BATCH_SIZE": {
        "title": "Rule Progress Batch Size",
        "description": "Minimum completed-stock delta before persisting progress for large async rule runs.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "RULE_PROGRESS_MIN_INTERVAL_SECONDS": {
        "title": "Rule Progress Min Interval Seconds",
        "description": "Minimum wall-clock interval between persisted progress updates for large async rule runs.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
