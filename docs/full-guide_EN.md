...
| `REALTIME_CACHE_TTL` | Short real-time quote cache TTL in seconds; caches per-stock quotes and whole-market DataFrames by time bucket. `0` disables the in-process cache. | `30` | Optional |
